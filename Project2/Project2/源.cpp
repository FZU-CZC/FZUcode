#include "C:\Users\独孤\Desktop\Armor-recognition-master\ArmorDetector\ArmorDetector.h"
#include <cmath>
#include <iostream>
...
int main()
{
	...
	char Image_RED[] = "C:\\myimage\\装甲板红.mp4";
	char Image_BLUE[] = "C:\\myimage\\video.mp4";
